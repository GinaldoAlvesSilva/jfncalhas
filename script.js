document.addEventListener("DOMContentLoaded", () => {
    ...
    const produtos = [
        {
            id: 1,
            nome: "Telhado Trapezoidal Térmico",
            categoria: "Telhado Metalico",
            preco: 0.0,
            imagem:
                "./assets/TelhadoSanduiche2.jpeg",
            descricao: "Pergolado com estrutura em madeira e cobertura em telha sanduíche, ideal para áreas externas, proporcionando proteção contra sol e chuva com um design moderno. Valor sob consulta",
        },
        {
            id: 2,
            nome: "Exaustor Ventisol 40cm",
            categoria: "Exaustores",
            preco: 450.00,
            imagem:
                "./assets/exaustor-40cm-ventisol.jpeg",
            descricao: "Exaustor Ventisol 40cm - Potente e silencioso, ideal para cozinhas e áreas de serviço, garantindo ventilação eficiente e renovação do ar.",
        },
        {
            id: 3,
            nome: "Calha com pintura Eletrostática Marrom",
            categoria: "Calha com pintura eletrostática",
            preco: 0.00,
            imagem:
                "./assets/CalhaEletrostaticaMarrom.jpeg",
            descricao: "Durável e resistente, perfeita para proteger sua casa contra infiltrações, com acabamento de alta qualidade e longa durabilidade. Valor sob consulta",
        },
        {
            id: 4,
            nome: "Coifa com pintura Eletrostática e Exaustão",
            categoria: "unissex",
            preco: 0.00,
            imagem:
                "./assets/CoifaColarinho.jpeg",
            descricao: "Coifa sob medida com colarinho epintura eletrostática e sistema de exaustão.",
        },
        {
            id: 5,
            nome: "Calha com pintura Eletrostática Branca",
            categoria: "Calha com pintura eletrostática",
            preco: 0.00,
            imagem:
                "./assets/CalhaEletrostaticaBranca.jpeg",
            descricao: "A moldura para o seu telhado, calha com pintura eletrostática branca, resistente e durável. Valor sob consulta",
        },
        {
            id: 6,
            nome: "Curva 45° 10 polegadas sem pintura Eletrostática",
            categoria: "Tubulação Exaustão",
            preco: 0.00,
            imagem:
                "./assets/curva-45graus.jpeg",
            descricao: "Curva 45° 10 polegadas sem pintura Eletrostática",
        },
